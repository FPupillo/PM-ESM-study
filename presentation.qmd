...
packages <- c("brms", "dplyr", "haven", "gt", "lme4", "tidyr", #"ggdist",
...
The tested path model
![Figure 1. Hypothesised path model](path_model.png)
...
labels <- c(
  "Offloading ~ Age group",
  "Task monitoring ~ Stress (B) × Age group",
  "Task monitoring ~ Age group",
  "PM ~ Offloading (W) × Age group",
  "PM ~ Importance (B) × Age group",
  "Offloading ~ Stress (B)",
  "PM ~ Business (B) × Age group",
  "PM ~ Offloading (B) × Age group",
  "Offloading ~ Business (W)",
  "Offloading ~ Business (B)",
  "Task monitoring ~ Business (W) × Age group",
  "PM ~ Importance (W) × Age group",
  "Offloading ~ Stress (B)",
  "Task monitoring ~ Day",
  "PM ~ Stress (B) × Age group",
  "Offloading ~ Importance (W) × Age group",
  "PM ~ Stress (W) × Age group",
  "PM ~ Business (W) × Age group",
  "PM ~ Stress (W)",
  "Task monitoring ~ Stress (W) × Age group",
  "Task monitoring ~ Business (B)",
  "Task monitoring ~ Stress (W)",
  "PM ~ Stress (B)",
  "Offloading ~ Day",
  "Task monitoring ~ Stress (B)",
  "PM ~ Day",
  "Task monitoring ~ Importance (W)",
  "PM ~ Age group",
  "PM ~ Business (B)",
  "PM ~ Task monitoring (B) × Age group",
  "Task monitoring ~ Importance (B) × Age group",
  "PM ~ Task monitoring (W) × Age group",
  "PM ~ Task monitoring (B)",
  "PM ~ Task monitoring (W)",
  "PM ~ Business (W)",
  "Offloading ~ Business (W) × Age group",
  "Offloading ~ Stress (W) × Age group",
  "Task monitoring ~ Importance (W) × Age group",
  "Offloading ~ Stress (W)",
  "PM ~ Importance (B)",
  "Task monitoring ~ Importance (B)",
  "Task monitoring ~ Business (W)",
  "PM ~ Offloading (B)",
  "Offloading ~ Importance (W)",
  "Offloading ~ Business (B) × Age group",
  "PM ~ Importance (W)",
  "Offloading ~ Importance (B) × Age group",
  "PM ~ Offloading (W)",
  "Offloading ~ Importance (B)"
)
